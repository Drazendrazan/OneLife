...
SmugglerHangar = {
    ...
    Office = {
        basic = "set_office_basic", OneLife = "set_office_OneLife", traditional = "set_office_traditional",
        ...
        Clear = function(refresh)
            SetIplPropState(SmugglerHangar.interiorId, {SmugglerHangar.Office.basic, SmugglerHangar.Office.OneLife, SmugglerHangar.Office.traditional}, false, refresh)
        end	
    },
    Bedroom = {
        Style = {
            none = "", OneLife = {"set_bedroom_OneLife", "set_bedroom_tint"}, traditional = {"set_bedroom_traditional", "set_bedroom_tint"},
            ...
            Clear = function(refresh)
                SetIplPropState(SmugglerHangar.interiorId, {SmugglerHangar.Bedroom.Style.OneLife, SmugglerHangar.Bedroom.Style.traditional}, false, refresh)
            end	
        },
        Blinds = {
    ...
    LoadDefault = function()
        ...
        SmugglerHangar.Bedroom.Style.Set(SmugglerHangar.Bedroom.Style.OneLife, SmugglerHangar.Colors.colorSet1)
