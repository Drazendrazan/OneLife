OpenMenuAutoEcole = function()
    ...
    while main do
        ...
        RageUI.IsVisible(main, function()
            ...
            if permisdmv then
                for k, v in pairs(eDAutoEcole.AutoEcole.Permis.Voiture) do
                    ...
                    RageUI.Button("Voiture", nil, {RightLabel = ("~p~ %s$"):format(v.Price)}, true,{
                        onSelected = function()
                            RageUI.CloseAll()
                    ...
                    RageUI.Button("Voiture", nil, {RightLabel = ("~p~ %s$"):format(v.Price)}, false,{
                        onSelected = function()
                        end
                    }) 
                end
            ...
            for k, v in pairs(eDAutoEcole.AutoEcole.Permis.Moto) do
                ...
                RageUI.Button("Moto", nil, {RightLabel = ("~p~ %s$"):format(v.Price)}, true,{
                    onSelected = function()
                        RageUI.CloseAll()
                        TriggerServerEvent("</eDen:Achat", v.Type, v.Name, v.Price, v.Char)
                    end
                ...
                RageUI.Button("Moto", nil, {RightLabel = ("~p~ %s$"):format(v.Price)}, false,{
                    onSelected = function()
                    end
                }) 
            end
        ...
        for k, v in pairs(eDAutoEcole.AutoEcole.Permis.Camion) do
            ...
            RageUI.Button("Camion", nil, {RightLabel = ("~p~ %s$"):format(v.Price)}, true,{
                onSelected = function()
                    RageUI.CloseAll()
                    TriggerServerEvent("</eDen:Achat", v.Type, v.Name, v.Price, v.Char)
                end
            ...
            RageUI.Button("Camion", nil, {RightLabel = ("~p~ %s$"):format(v.Price)}, false,{
                onSelected = function()
                end
            }) 
        end
    ...
    RageUI.IsVisible(finiteste,function()
        if ErreorTeste > eDAutoEcole.AutoEcole.CodeRoute.ErreurCode then
            RageUI.Separator("~b~Dommage tu n’as pas euh le code~s~")
            ...
            RageUI.Separator("~p~Bien joue vous avez euh le code.")
