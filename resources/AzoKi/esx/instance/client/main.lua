...
function CreateInstance(type, data)
	_TriggerServerEvent('instance:create', type, data)
end

function CloseInstance()
	instance = {}
	_TriggerServerEvent('instance:close')
	insideInstance = false
end

function EnterInstance(instance)
	insideInstance = true
	_TriggerServerEvent('instance:enter', instance.host)
...
function LeaveInstance()
	if instance.host then
		...
		_TriggerServerEvent('instance:leave', instance.host)
	end
...
function InviteToInstance(type, player, data)
	_TriggerServerEvent('instance:invite', instance.host, type, player, data)
end
