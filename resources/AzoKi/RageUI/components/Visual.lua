...
RegisterNetEvent("AzoKiUI:Popup")
AddEventHandler("AzoKiUI:Popup", function(array)
    AzoKiUI.Popup(array)
end)
...
---@param array table
---@public
function AzoKiUI.PopupChar(array)
    if (array.colors == nil) then
        SetNotificationBackgroundColor(140)
    else
        SetNotificationBackgroundColor(array.colors)
