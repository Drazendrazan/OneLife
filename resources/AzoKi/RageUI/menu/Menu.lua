...
---@return table
---@public
function AzoKiUI.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.DescriptionHeight = AzoKiUI.Settings.Items.Description.Background.Height
    Menu.X = X or 0
    Menu.Y = Y or 0
    Menu.Parent = nil
    Menu.WidthOffset = AzoKiUI.UI.Style[AzoKiUI.UI.Current].Width
    Menu.Open = false
    Menu.Controls = AzoKiUI.Settings.Controls
    Menu.Index = 1
    ...
    if Menu.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(Menu.Subtitle, Menu.X + AzoKiUI.Settings.Items.Subtitle.Text.X, Menu.Y + AzoKiUI.Settings.Items.Subtitle.Text.Y, 0, AzoKiUI.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, AzoKiUI.Settings.Items.Subtitle.Background.Width + Menu.WidthOffset)
    ...
    return setmetatable(Menu, AzoKiUI.Menus)
end
...
---@return table
---@public
function AzoKiUI.CreateSubMenu(ParentMenu, Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
...
---@return nil
---@public
function AzoKiUI.Menus:SetTitle(Title)
    self.Title = Title
end
...
---@return nil
---@public
function AzoKiUI.Menus:SetStyleSize(Value)
    local witdh
...
---@return any
---@public
function AzoKiUI.Menus:GetStyleSize()
...
---@return void
---@public
function AzoKiUI.Menus:SetCursorStyle(Int)
...
---@return void
---@public
function AzoKiUI.Menus:ResetCursorStyle()
    self.CursorStyle = 1
...
---@return void
---@public
function AzoKiUI.Menus:UpdateCursorStyle()
...
---@return void
---@public
function AzoKiUI.Menus:RefreshIndex()
    self.Index = 1
end
...
---@return nil
---@public
function AzoKiUI.Menus:SetSubtitle(Subtitle)
    ...
    if self.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(self.Subtitle, self.X + AzoKiUI.Settings.Items.Subtitle.Text.X, self.Y + AzoKiUI.Settings.Items.Subtitle.Text.Y, 0, AzoKiUI.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, AzoKiUI.Settings.Items.Subtitle.Background.Width + self.WidthOffset)
...
---@return nil
---@public
function AzoKiUI.Menus:SetPageCounter(Subtitle)
...
---@return nil
---@public
function AzoKiUI.Menus:EditSpriteColor(color)
...
---@return nil
---@public
function AzoKiUI.Menus:SetPosition(X, Y)
...
---@return nil
---@public
function AzoKiUI.Menus:SetTotalItemsPerPage(Value)
...
---@return nil
---@public
function AzoKiUI.Menus:SetRectangleBanner(R, G, B, A)
...
---@return nil
---@public
function AzoKiUI.Menus:SetSpriteBanner(TextureDictionary, Texture)
    self.Sprite = { Dictionary = TextureDictionary or "commonmenu", Texture = Texture or "interaction_bgd" }
    self.Rectangle = nil
end

function AzoKiUI.Menus:Closable(boolean)
...
function AzoKiUI.Menus:AddInstructionButton(button)
...
function AzoKiUI.Menus:RemoveInstructionButton(button)
...
function AzoKiUI.Menus:UpdateInstructionalButtons(Visible)
