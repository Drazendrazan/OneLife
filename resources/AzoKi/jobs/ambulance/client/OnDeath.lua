	...
	Citizen.CreateThread(function()
		...
		while SetEntityRagdoll do
			...
			RageUI.IsVisible(DeathMenu, function()
				RageUI.Separator('')
				RageUI.Separator('~p~Vous êtes inconscient')
				RageUI.Separator('Temps restant ~p~'..IsTimeDead..' ~w~minutes')
				RageUI.Separator('')
				...
				--RageUI.Button('Réaparaitre rapidement (VIP)', nil,  {RightLabel = '~p~VIP Diamond~s~'}, IsVIP, {
					--onSelected = function()
