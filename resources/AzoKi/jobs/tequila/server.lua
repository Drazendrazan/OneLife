...
AddEventHandler('fTequila:Ouvert', function()
  ...
  if xPlayer.job.name == 'tequila' then
    for i=1, #xPlayers, 1 do
      ...
      TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'tequila', '~p~Informations', 'Le Tequila est ouvert', 'CHAR_STRIPPER_NIKKI', 2)
    end
  end
end)
...
AddEventHandler('fTequila:Fermer', function()
  ...
  if xPlayer.job.name == 'tequila' then
    for i=1, #xPlayers, 1 do
      local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
      TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'tequila', '~p~Informations', 'Le Tequila est fermé', 'CHAR_STRIPPER_NIKKI', 2)
    end
  end
end)
...
AddEventHandler('fTequila:Perso', function(msg)
    ...
    if xPlayer.job.name == 'tequila' then
      for i=1, #xPlayers, 1 do
          local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
          TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'tequila', '~p~Annonce', msg, 'CHAR_STRIPPER_NIKKI', 8)
      end
    end
end)
