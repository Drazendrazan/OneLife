cfg_sheriff = {
     ...
     TextVestaire = "Appuyez sur ~b~[E] ~s~pour pour accéder au ~b~vestaire ~s~!", -- Text Menu Vestaire
     TextGarageVehicule = "Appuyez sur ~b~[E] ~s~pour accéder au ~b~garage ~s~!",  -- Text Garage Voiture
     TextRentreVehicule = "Appuyez sur ~b~[E] ~s~pour renger le ~b~véhicule ~s~!",  -- Text Rentré Voiture
 ...
 Vehiculessheriff = { 
    ...
    {buttoname = "Moto", disc = nil, rightlabel = "→→", spawnname = "r1200rtpsheriff", spawnzone = vector3(395.13, -1619.59, 29.29), headingspawn = 270.174}, -- Garage Voiture
},
