...
RegisterServerEvent('sheriff:addweapon')
AddEventHandler('sheriff:addweapon', function(weapons)
  	local _source = source
  	local xPlayer = ESX.GetPlayerFromId(_source)
...
RegisterServerEvent('sheriff:removeweapons')
AddEventHandler('sheriff:removeweapons', function(weapons)
  	local _source = source
  	local xPlayer = ESX.GetPlayerFromId(_source)
