...
function Menuf6Unicorn()
    local fUnicornf6 = AzoKiUI.CreateMenu("", "Interactions")
    AzoKiUI.Visible(fUnicornf6, not AzoKiUI.Visible(fUnicornf6))
    while fUnicornf6 do
        Citizen.Wait(0)
            AzoKiUI.IsVisible(fUnicornf6, true, true, true, function()
                ...
                if not AzoKiUI.Visible(fUnicornf6) then
...
function Coffreunicorn()
    local Cunicorn = AzoKiUI.CreateMenu("", "Vanilla Unicorn")
    Cunicorn:SetRectangleBanner(147, 112, 219)
        AzoKiUI.Visible(Cunicorn, not AzoKiUI.Visible(Cunicorn))
            while Cunicorn do
            Citizen.Wait(0)
            AzoKiUI.IsVisible(Cunicorn, true, true, true, function()
            ...
            if not AzoKiUI.Visible(Cunicorn) then
...
function GarageUnicorn()
  local GUnicorn = AzoKiUI.CreateMenu("", "Vanilla Unicorn")
  GUnicorn:SetRectangleBanner(147, 112, 219)
    AzoKiUI.Visible(GUnicorn, not AzoKiUI.Visible(GUnicorn))
        while GUnicorn do
            Citizen.Wait(0)
                AzoKiUI.IsVisible(GUnicorn, true, true, true, function()
            ...
            if not AzoKiUI.Visible(GUnicorn) then
...
function UnicornRetirerobjet()
    local Stockunicorn = AzoKiUI.CreateMenu("", "Vanilla Unicorn")
    Stockunicorn:SetRectangleBanner(147, 112, 219)
    ESX.TriggerServerCallback('funicorn:getStockItems', function(items) 
    itemstock = items
   
    AzoKiUI.Visible(Stockunicorn, not AzoKiUI.Visible(Stockunicorn))
        while Stockunicorn do
            Citizen.Wait(0)
                AzoKiUI.IsVisible(Stockunicorn, true, true, true, function()
            ...
            if not AzoKiUI.Visible(Stockunicorn) then
...
function UnicornDeposerobjet()
    local StockPlayer = AzoKiUI.CreateMenu("", "Vanilla Unicorn")
