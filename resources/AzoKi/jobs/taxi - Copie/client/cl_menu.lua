...
local open = false 
local mainMenu8 = RageUI.CreateMenu('', '~y~Interaction')
local subMenu8 = RageUI.CreateSubMenu(mainMenu8, "", "~y~Interaction")
								...
								if (GetOnscreenKeyboardResult()) then
									...
									if result then
										...
										if player ~= -1 and distance <= 3.0 then
											...
											ESX.ShowNotification("~b~Problèmes~s~: Aucun joueur à proximitée")
										end
									end
								end
