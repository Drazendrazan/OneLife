cfg_policeWebhookRendezVousPolice = "https://discord.com/api/webhooks/919786065534025788/qrk1JNpDpKhIPuPv8jJTVI9B5JUfn-LVbWHkJ7FQUcVPykHwT8bfRdpDL2e2uqxCrrbi" -- Metez le webhook de votre salon disocrd cfg_policeure pour le job ems 
...
cfg_police = {
     ...
     TextCoffre = "Appuyez sur ~b~[E] ~s~pour accéder au ~b~coffre ~s~!",  -- Text Menu coffre
     TextVestaire = "Appuyez sur ~b~[E] ~s~pour pour accéder au ~b~vestiaire ~s~!", -- Text Menu Vestaire
     TextGarageVehicule = "Appuyez sur ~b~[E] ~s~pour accéder au ~b~garage ~s~!",  -- Text Garage Voiture
     TextRentreVehicule = "Appuyez sur ~b~[E] ~s~pour ranger le ~b~véhicule ~s~!",  -- Text Rentrer Voiture
     TextGarageHeli = "Appuyez sur ~b~[E] ~s~pour accéder au ~b~garage ~s~!",  -- Text Garage Hélico
     TextAccueil = "Appuyez sur ~b~[E] ~s~pour parler au secrétaire ~s~!",  -- Text Ascenseur
...
Position = {
        ...
        Vestaire = {vector3(461.07910, -996.447937, 30.6895)}, -- Menu Vestiaire 
