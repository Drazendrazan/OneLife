...
local open = false 
local mainMenu6 = RageUI.CreateMenu('', '~b~Garage Véhicule LSPD')
...
local open = false 
local mainMenu6 = RageUI.CreateMenu('', '~b~Garage Hélicoptère')
mainMenu6.Display.Header = true 
mainMenu6.Closed = function()
  open = false
end
...
RMenu.Add('police', 'vehicle_option', RageUI.CreateMenu("", "~b~Option véhicule"))
