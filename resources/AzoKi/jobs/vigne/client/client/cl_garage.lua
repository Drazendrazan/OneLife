...
local open = false 
local mainMenu6 = RageUI.CreateMenu('', '~p~Interaction')
            ...
            RageUI.IsVisible(mainMenu6,function() 
              ...
              RageUI.Button("Pick-Up", nil, {RightLabel = "→→"}, true , {
                    onSelected = function()
                      ...
                      TriggerEvent("esx:showAdvancedNotification", '~p~Vigneron', '~p~Votre véhicule de service a été sorti.', '~p~Voici la plaque : ~p~'..GetVehicleNumberPlateText(vehicle).. '\n~p~Vous avez aussi reçu les clés !', 'CHAR_LEST_MIKE_CONF', 'spawn', 8)
