...
local open = false 
local mainMenu8 = RageUI.CreateMenu('', '~p~Interaction')
local subMenu8 = RageUI.CreateSubMenu(mainMenu8, "", "~p~Interaction")
local subMenu10 = RageUI.CreateSubMenu(mainMenu8, "", "~p~Interaction")
