...
function Menuf6UberEat()
    local fUberEatf6 = AzoKiUI.CreateMenu("", "Interactions")
    fUberEatf6:SetRectangleBanner(153, 50, 204)
    AzoKiUI.Visible(fUberEatf6, not AzoKiUI.Visible(fUberEatf6))
    while fUberEatf6 do
        Citizen.Wait(0)
            AzoKiUI.IsVisible(fUberEatf6, true, true, true, function()
                ...
                if not AzoKiUI.Visible(fUberEatf6) then
...
function CoffreUberEat()
    local CUberEat = AzoKiUI.CreateMenu("", "UberEat")
    CUberEat:SetRectangleBanner(153, 50, 204)
        AzoKiUI.Visible(CUberEat, not AzoKiUI.Visible(CUberEat))
            while CUberEat do
            Citizen.Wait(0)
            AzoKiUI.IsVisible(CUberEat, true, true, true, function()
            ...
            if not AzoKiUI.Visible(CUberEat) then
...
function GarageUberEat()
  local GUberEat = AzoKiUI.CreateMenu("", "UberEat")
  GUberEat:SetRectangleBanner(153, 50, 204)
    AzoKiUI.Visible(GUberEat, not AzoKiUI.Visible(GUberEat))
        while GUberEat do
            Citizen.Wait(0)
                AzoKiUI.IsVisible(GUberEat, true, true, true, function()
            ...
            if not AzoKiUI.Visible(GUberEat) then
...
function UberEatRetirerobjet()
    local StockUberEat = AzoKiUI.CreateMenu("", "UberEat")
    StockUberEat:SetRectangleBanner(153, 50, 204)
    ESX.TriggerServerCallback('fUberEat:getStockItems', function(items) 
    itemstock = items
   
    AzoKiUI.Visible(StockUberEat, not AzoKiUI.Visible(StockUberEat))
        while StockUberEat do
            Citizen.Wait(0)
                AzoKiUI.IsVisible(StockUberEat, true, true, true, function()
            ...
            if not AzoKiUI.Visible(StockUberEat) then
...
function UberEatDeposerobjet()
    local StockPlayer = AzoKiUI.CreateMenu("", "UberEat")
