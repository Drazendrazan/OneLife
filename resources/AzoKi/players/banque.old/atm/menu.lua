      ...
      openatmenu = true 
         ...
         while openatmenu do
          ...
          RageUI.IsVisible(atmcompte,function()
              ...
              RageUI.Button("Mon Solde Bancaire :", nil, {RightLabel = "~b~"..PlayerMoney.."$~s~"}, true , {
                onSelected = function()
                end
              })
              ...
              RageUI.Button("Faire un ~b~Retrait", nil, {RightLabel = "→→"}, true , {
                onSelected = function()
                  mytypecompte = nil
                  gettypecompte()
                end
              ...
              RageUI.Button("Faire un ~y~Transfère", nil, {RightLabel = "→→"}, true , {
                onSelected = function()
                end
              },menutrans)
                          ...
                          if tonumber(retr1000max) == nil then
                            ...
                            sommme = (tonumber(retr1000max))
                                if sommme < 1001 then
                                    ...
                                    AddBankTransaction("Retrait de ~b~"..sommme.."$~w~")
                                    GetPlayerMoney()
                                    GetPlayerMoneySolde()
                                else
                                    if sommme > 1001 then
                    ...
                    if mytypecompte.type == "2" then
                        RageUI.Button("Faire un retrait de 5000$", "Cette Action est automatique", {RightLabel = "→→"}, true , {
                          onSelected = function()
                            ...
                            AddBankTransaction("Retrait de ~b~5000$~w~")
                            GetPlayerMoney()
                            GetPlayerMoneySolde()
                          end
                        })
                            ...
                            if tonumber(retr5000max) == nil then
                              ...
                              sommme5k = (tonumber(retr5000max))
                                  if sommme5k < 5001 then
                                      ...
                                      AddBankTransaction("Retrait de ~b~"..sommme5k.."$~w~")
                                      GetPlayerMoney()
                                      GetPlayerMoneySolde()
                                  else
                                      if sommme5k > 5001 then
                      ...
                      RageUI.Button("Faire un retrait personnalisé", "Libre à vous de choisir le montant", {RightLabel = "→→"}, true , {
                        onSelected = function()
                          ...
                          if tonumber(retrait) == nil then
                            ...
                            AddBankTransaction("Retrait de ~b~"..sommmeperso.."$~w~")
                            GetPlayerMoney()
                            GetPlayerMoneySolde()
                          end
                        end
                      ...
                      onSelected = function()
                        if myverifmdp then
                            if myverifmdp.motdpasse == mdp then
                                ...
                                ShowNotification("Mot de Passe ~b~Incorrect~s~")
                            end
                        end 
                      end
                    })
  ...
  while true do
      ...
      for k,v in pairs(Banquee.ATM) do
          if #(PlyCoord - v.posi) < 2.0 then
            interval = 1
            ESX.ShowHelpNotification("Appuyez sur ~b~E~s~ pour insérer votre carte")
