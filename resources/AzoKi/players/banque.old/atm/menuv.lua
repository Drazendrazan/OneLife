...
AddEventHandler('BBanque:getcardecompte', function()
    ...
    if cbposs.count <= 0 then
        TriggerClientEvent('esx:showAdvancedNotification', source, 'Banque', 'Information', "Désoler mais vous n'avez pas de carte Bancaire sur vous.", 'CHAR_BANK_FLEECA', 8)
    else
...
AddEventHandler("BBanque:moins1000", function()
    ...
    xPlayer.addAccountMoney('cash', price)
        TriggerClientEvent('esx:showAdvancedNotification', _source, 'Banque', 'Information', "Retrait de ~g~1000$~s~ effectué", 'CHAR_BANK_FLEECA', 8)
    else
        TriggerClientEvent('esx:showNotification', _source, "~b~Tu n'as pas assez d'argent")
    end    
end)
...
AddEventHandler("BBanque:moins5000", function()
    ...
    xPlayer.removeAccountMoney('bank', price)
    xPlayer.addAccountMoney('cash', price)
        TriggerClientEvent('esx:showAdvancedNotification', _source, 'Banque', 'Information', "Retrait de ~g~5000$~s~ effectué", 'CHAR_BANK_FLEECA', 8)
    else
        TriggerClientEvent('esx:showNotification', _source, "~b~Tu n'as pas assez d'argent")
    end    
end)
...
AddEventHandler("BBanque:retraitperso", function(sommme)
    ...
    if xMoney >= price then
        ...
        xPlayer.addAccountMoney('cash', price)
        xPlayer.removeAccountMoney('bank', price)
        TriggerClientEvent('esx:showAdvancedNotification', _source, 'Banque', 'Information', "Dépôt de ~g~"..price.."$~s~ effectué", 'CHAR_BANK_FLEECA', 8)
    else
        TriggerClientEvent('esx:showNotification', _source, "~b~Tu n'as pas assez d'argent")
    end    
end)
...
AddEventHandler("BBanque:retraitperso5k", function(sommme5k)
    ...
    xPlayer.removeAccountMoney('bank', price)
    xPlayer.addAccountMoney('cash', price)
        TriggerClientEvent('esx:showAdvancedNotification', _source, 'Banque', 'Information', "Retrait de ~g~"..price.."$~s~ effectué", 'CHAR_BANK_FLEECA', 8)
    else
        TriggerClientEvent('esx:showNotification', _source, "~b~Tu n'as pas assez d'argent")
    end    
end)
...
AddEventHandler("BBanque:dep1000", function()
    ...
    xPlayer.addAccountMoney('bank', price)
    xPlayer.removeAccountMoney('cash', price)
        TriggerClientEvent('esx:showAdvancedNotification', _source, 'Banque', 'Information', "Dépôt de ~g~1000$~s~ effectué", 'CHAR_BANK_FLEECA', 8)
    else
        TriggerClientEvent('esx:showNotification', _source, "~b~Tu n'as pas assez d'argent")
    end    
end)
...
AddEventHandler("BBanque:dep5000", function()
    ...
    xPlayer.addAccountMoney('bank', price)
    xPlayer.removeAccountMoney('cash', price)
        TriggerClientEvent('esx:showAdvancedNotification', _source, 'Banque', 'Information', "Dépôt de ~g~5000$~s~ effectué", 'CHAR_BANK_FLEECA', 8)
    else
        TriggerClientEvent('esx:showNotification', _source, "~b~Tu n'as pas assez d'argent")
    end    
end)
...
AddEventHandler('bank:transfer', function(to, amountt)
    ...
    if zPlayer ~= nil and GetPlayerEndpoint(to) ~= nil then
        ...
        if tonumber(_source) == tonumber(to) then
            TriggerClientEvent('esx:showAdvancedNotification', _source, 'Banque','Transférer de l\'argent','Vous ne pouvez pas vous transférer !','CHAR_BANK_MAZE', 9)
        else
            if balance <= 0 or balance < tonumber(amountt) or tonumber(amountt) <=
                0 then
                TriggerClientEvent('esx:showAdvancedNotification', _source,'Banque', 'Transférer de l\'argent','Pas assez d\'argent à transférer !','CHAR_BANK_MAZE', 9)
            else
                xPlayer.removeAccountMoney('bank', tonumber(amountt))
                zPlayer.addAccountMoney('bank', tonumber(amountt))
                TriggerClientEvent('esx:showAdvancedNotification', _source,'Banque', 'Transférer de l\'argent','Vous avez transféré ~b~$' .. amountt ..'~s~ à ~b~' .. to .. ' .','CHAR_BANK_MAZE', 9)
                TriggerClientEvent('esx:showAdvancedNotification', to, 'Banque','Transférer de l\'argent', 'Vous avez reçu ~b~$' ..amountt .. '~s~ de ~b~' .. _source ..' .', 'CHAR_BANK_MAZE', 9)
            end
        end
    end
end)
