    ...
    while main do
        ...
        RageUI.IsVisible(main, function()
            ...
            RageUI.Button('name de l\'Item ( Pour give )', nil, {RightLabel = '>'}, true, {
                onSelected = function()
					if UpdateOnscreenKeyboard() == 0 then return end
					local string = KeyboardInput('Nom de l\'item', '', 999)
					if string ~= "" then
						ItemRecolte = string 
					end
                end
            ...
            RageUI.Separator("↓ ~p~Traitement ~w~ ↓")
            ...
            RageUI.Separator("↓ ~p~Prix de Vente ~w~ ↓")
            RageUI.Button('Prix de Vente', nil, {RightLabel = '>'}, true, {
                onSelected = function()
					if UpdateOnscreenKeyboard() == 0 then return end
					local string = KeyboardInput('Prix de la vente', '', 999)
					if string ~= "" then
						PrixVente = string 
					end
                end
            ...
            RageUI.Button('~p~Sauvegarder', nil, { RightBadge = RageUI.BadgeStyle.Tick, Color = { BackgroundColor = {0, 120, 0, 200} } }, true, {
                onSelected = function()
            ...
            --RageUI.Separator("↓ ~p~Evenements Légal ~w~ ↓")
        end)
