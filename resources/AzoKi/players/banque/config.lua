...
rBank.jeveuxmarkerbanque = true -- Marker pour les point de banque
rBank.jeveuxmarkeratm = true  -- Marker pour les point de ATM
rBank.jeveuxblipsatm = true

rBank.Size         = {x = 1.0, y = 1.0, z = 1.0}
rBank.Color        = {r = 255, g = 255, b = 255}
rBank.Type         = 29

rBank.GetPlayerMoney = function(action)
...
rBank.posatm = {
    ...
    {x=122.04, y=-1293.37, z=29.26}, --Unicorn
    {x=33.24, y=-1347.91, z=29.50}, --Unicorn
}