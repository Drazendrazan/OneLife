...
StringsLocalFuel = {
	...
	EToRefuel = "Appuyez sur ~p~E ~w~pour faire le plein du véhicule",
	JerryCanEmpty = "Le Bidon de JerryCan est vide",
	FullTank = "Le réservoir est plein",
	PurchaseJerryCan = "Appuyez sur ~p~E ~w~ pour acheter un jerrican de ~p~$" .. JerryCanCostFuel,
	CancelFuelingPump = "Appuyez sur ~p~E ~w~pour annuler le ravitaillement",
	CancelFuelingJerryCan = "Appuyez sur ~p~E ~w~pour annuler le ravitaillement",
	NotEnoughCash = "~p~Pas assez d'argent",
	RefillJerryCan = "Appuyez sur ~p~E ~w~ pour remplir le jerrican pour ",
