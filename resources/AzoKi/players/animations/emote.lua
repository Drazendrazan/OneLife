...
Sexe = {
    {name = "Twerk", value = "switch@trevor@mocks_lapdance",  anim ="001443_01_trvs_28_idle_stripper", loop = 1, command = "twerk"},
    {name = "Faire du charme", value = "mini@strip_club@idles@stripper", anim = "stripper_idle_02",loop = 1, command = "charme"},
    {name = "Montrer ses Seins", value = "mini@strip_club@backroom@", anim = "stripper_b_backroom_idle_b",loop = 1, command = "boobs"},
    {name = "Dans ton Cul", value = "anim@mp_player_intcelebrationmale@dock", anim = "dock",loop = 1, command = "ass"},
    {name = "Se gratter les couilles", value = "mp_player_int_uppergrab_crotch", anim = "mp_player_int_grab_crotch",loop = 1, command = "scratchingballs"},
    {name = "Se gratter le cul", value = "mp_player_int_upperarse_pick", anim ="mp_player_int_arse_pick",loop = 1, command = "scratchingass"},
    {name = "Strip Tease 1", value = "mini@strip_club@lap_dance@ld_girl_a_song_a_p1",  anim ="ld_girl_a_song_a_p1_f",loop = 1, command = "strip"},
    {name = "Strip Tease 2", value = "mini@strip_club@private_dance@part2", anim = "priv_dance_p2",loop = 1, command = "strip2"},
    {name = "Strip Tease au sol", value = "mini@strip_club@private_dance@part3",  anim ="priv_dance_p3",loop = 1, command = "strip3"},
    {name = "Lapdance", value = "mp_safehouse",  anim ="lap_dance_girl",loop = 1, command = "lapdance"},
    {name = "Fellation", value = "misscarsteal2pimpsex",  anim ="pimpsex_hooker",loop = 1, command = "pipe"},
    {name = "Femme faire une gaterie en voiture", value = "oddjobs@towing",  anim ="f_blow_job_loop",loop = 1, command = "pipcar"},
    {name = "Femme bais** en voiture", value = "mini@prostitutes@sexlow_veh", anim ="low_car_sex_loop_female",loop =1, command = "fuckcar"},
    {name = "Homme se faire su*** en voiture", value = "oddjobs@towing",  anim ="m_blow_job_loop",loop = 0, command = "pipcar2"},
    {name = "Homme bais** en voiture", value = "mini@prostitutes@sexlow_veh",  anim ="low_car_sex_loop_player", loop = 1, command = "fuckcar2"},
    {name = "Se mettre penché", value = "random@street_race",  anim ="_car_a_flirt_girl", loop = 1, command = "wendy"},
...
Musique = {
        {
            ...
            type11  = " ~p~↓↓~s~ Danse bâtons lumineux ~p~↓↓",
            glowstickdanse = {
