Locales['fr'] = {
	  ...
	  ['remaining_msg'] = 'il reste ~p~%s~s~ secondes avant votre sortie de prison',
	  ['jailed_msg'] = '%s est maintenant en prison pour %s minutes',
	  ['unjailed'] = '%s a été libéré de prison !',

	  ['shop_robbery'] = 'braquage magasin',
	  ['press_to_rob'] = 'appuyez sur ~INPUT_CONTEXT~ ~o~pour braquer~s~ ~p~%s~s~',
	  ['robbery_timer'] = 'braquage magasin: il reste ~p~%s~s~ secondes',
	  ['recently_robbed'] = 'ce magasin a déjà été braqué. Attendez ~p~%s~p~ secondes.',
	  ['rob_in_prog'] = '~p~Braquage en cours à: ~p~%s~s~',
	  ['started_to_rob'] = 'vous avez commencé à braquer ~p~%s~s~',
	  ['alarm_triggered'] = 'l\'alarme a été déclenchée',
	  ['robbery_complete'] = '~p~Braquage terminé~s~. Vous avez ~o~volé~s~ ~p~$%s~s~',
	  ['robbery_complete_at'] = '~p~Braquage terminé à: ~p~%s~s~',
	  ['robbery_cancelled'] = 'le braquage va être annulé, vous ne gagnerez rien!',
	  ['robbery_cancelled_at'] = '~p~Braquage annulé à: ~p~%s~s~',
	  ['min_police'] = 'il faut minimum ~p~%s policiers~s~ en ville pour braquer.',
	  ['robbery_already'] = '~p~Un braquage est déjà en cours.',
	  ...
	  ['invoices'] = 'factures',
	  ['invoices_item'] = '$%s',
	  ['received_invoice'] = 'vous avez ~p~reçu~s~ une facture',
	  ['paid_invoice'] = 'vous avez ~p~payé~s~ une facture de ~p~$%s~s~',
	  ['received_payment'] = 'vous avez ~p~reçu~s~ un paiement de ~p~$%s~s~',
	  ['player_not_online'] = 'le joueur n\'est pas connecté',
	  ['no_money'] = 'you do not have enough money to pay this bill',
	  ['target_no_money'] = 'the player ~p~does not~s~ have enough money to pay the bill!',
	...
	['installed'] = 'installé',
	['already_own'] = 'vous possédez déjà: ~p~%s~s~',
