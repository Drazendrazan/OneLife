...
if GetConvar('voice_useNativeAudio', 'false') == 'true' then
	...
	Cfg.voiceModes = {
		...
		{3.0, "Parler"}, -- Normal speech distance in gta distance units
		{6.0, "Hurler"} -- Shout speech distance in gta distance units
	}
else
	Cfg.voiceModes = {
		{3.0, "Chuchoter"}, -- Whisper speech distance in gta distance units
		{7.0, "Parler"}, -- Normal speech distance in gta distance units
		{15.0, "Hurler"} -- Shout speech distance in gta distance units
	}
end
