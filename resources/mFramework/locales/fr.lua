Locales['fr'] = {
	...
	['received_money'] = 'vous avez reçu ~p~$%s~s~ par ~b~%s~s~',
	['gave_account_money'] = 'vous avez donné ~p~$%s~s~ (%s) à ~y~%s~s~',
	['received_account_money'] = 'vous avez reçu ~p~$%s~s~ (%s) par ~b~%s~s~',
	...
	['threw_money'] = 'vous avez jeté ~p~$%s~s~ ~b~cash~s~',
	['threw_account'] = 'vous avez jeté ~p~$%s~s~ ~b~%s~s~',
