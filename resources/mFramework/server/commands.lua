...
ESX.AddGroupCommand('car', 'admin', function(source, args, user)
...
ESX.AddGroupCommand('giveweapon', 'admin', function(source, args, user)
	local xPlayer = ESX.GetPlayerFromId(args[1])
...
ESX.AddGroupCommand('giveweaponcomponent', 'admin', function(source, args, user)
	local xPlayer = ESX.GetPlayerFromId(args[1])
...
ESX.AddGroupCommand('clearall', 'superadmin', function(source, args, user)
...
ESX.AddGroupCommand('cleargarage', 'superadmin', function(source, args, user)
	if tostring(args[1]) then
		TriggerEvent('pSociety:getSociety', tostring(args[1]), function(society)
